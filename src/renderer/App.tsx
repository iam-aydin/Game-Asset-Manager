    ...
    <Center h="100%">
      <Stack align="center" gap="xs">
        ...
        <Text size="sm" c="dimmed">
          Click "Add library" in the sidebar to point Game Asset Manager at a folder of 3D, Image, Audio files whatever.
        </Text>
      </Stack>
    </Center>
        ...
        <Stack gap={0} h="100%">
          <Group h={44} px="md" gap="md" wrap="nowrap">
            <Group gap={8} wrap="nowrap" style={{ flexShrink: 0 }}>
              <Logo size={22} />
              <Text fw={600}>Game Asset Manager</Text>
            </Group>
            ...
            <Select
              ...
              clearable
            />
            <Tooltip label="Support Game Asset Manager">
              <ActionIcon
                variant="subtle"
                component="a"
